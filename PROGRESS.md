...
- 2026-08-21 — BLUEPRINT: redrawing the diagram surfaced two mechanical bugs in the queue mechanism's own description — an ordering step that would have re-run on every item instead of once, and a classification step that was described as batch rather than sequential; both corrected
